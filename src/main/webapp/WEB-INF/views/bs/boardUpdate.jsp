                ...
                <div class="post">
                    <div class="post-header">
                        ...
                        <div class="user-details">
                            <strong class="name">${boardUpdate.nickname}</strong>
                    ...
                    <img src="data:image/jpeg;base64,${boardUpdate.boardImg}" alt="post" class="post-photo">  
                    <div class="post-footer">
                        ...
                        <div class="comments">
                            <p>
                                <textarea rows="10" cols="50" name="inus_content">${boardUpdate.inus_content}</textarea>
                            </p>
                        </div>
                        <span class="time"><fmt:formatDate value="${boardUpdate.inus_Date}" type="date" dateStyle="short"/></span>
